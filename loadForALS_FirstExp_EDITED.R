...
plotDat = T;
ncomp = 3;
path  <- "T:/Technik/Spektroskopie/UserData_p-mbe/IC 940 Professional Vaio/Project/Sugars/DecompositionExperiments/3rdDecomp";
...
# load all the data
###########################################################################
source('T:/Technik/Spektroskopie/UserData_p-mbe/R/R-Scripts/PCA_2_EDITED.R')
