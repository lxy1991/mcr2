...
postscript("Overlaid_spectra_ColSepDark.eps", horizontal = TRUE, onefile = FALSE, paper = "special", height = 8.26771654, width = 11.6929134)
matplot(decoS$wl, decoS[,-1], xlab = "Wavelength in nm", ylab = "Absorbance", main = "Overlaid spectra", type = "l", col = c, lty = 1)
dev.off()
png("Overlaid_spectraColSepDark.png", height = 2480, width = 3508, res = 300)
matplot(decoS$wl, decoS[,-1], xlab = "Wavelength in nm", ylab = "Absorbance", main = "Overlaid spectra", type = "l", col = c, lty = 1)
dev.off()
matplot(decoS$wl, decoS[,-1], xlab = "Wavelength in nm", ylab = "Absorbance", main = "Overlaid spectra", type = "l", col = c, lty = 1)
