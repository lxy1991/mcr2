Pfad <- "T:/Technik/Spektroskopie/UserData_p-mbe/IC 940 Professional Vaio/Project/Sugars/4-CalibrationSucrose.csv";   #path in which the csv with x and y values are
