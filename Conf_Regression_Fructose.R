Pfad <- "T:/Technik/Spektroskopie/UserData_p-mbe/IC 940 Professional Vaio/Project/Sugars/3-CalibrationFructose.csv";   #path in which the csv with x and y values are
...
plot(y ~ x, data = dataf, type = 'n', main="Calibration curve and confidence interval for Fructose", xlab="Conc. in ppm", ylab="Peakarea", axes=FALSE)
axis(1, pos=0)
axis(2, pos=0)
